      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-2 col-xl-9 ml-md-auto py-1"  style="margin-top:100px">
            <article>
              <h2>CBC Assessments</h2>
              <p class="lead">
                  To do CBC Assessments on the CBC Subjects, click on the <B>CBC Assessments </B> button.
              </p>
              <hr>
              <div class="code-preview">
                <img src="../manual_images/img/otherimages/cbcassessment.jpg" class="img-fluid" alt="Responsive image">
              </div>
              <hr>
            </article>
          <hr>
          <div class="row justify-content-around m-4 mb-6">
            ...
            <div class="col-md-7 img">
                <div class="code-preview">
                  <img src="../manual_images/img/otherimages2/formative.jpg" class="img-fluid" alt="Responsive image">
                </div>
                <hr>
          </div>
          ...
          <div class="row justify-content-around m-4">
            ...
            <div class="col-md-7 img">
              <hr>
                <div class="code-preview">
                  <img src="../manual_images/img/otherimages2/summative 1.jpg" class="img-fluid" alt="Responsive image">
                </div>
              </div>
            <div class="col-md-5 content">
              <article>
          ...
          <div class="row justify-content-around m-4 mb-6">
            <div class="col-md-5 content">
              <article>
                <hr>
                  <h3>Social Behaviour Assessment</h3>
                  <p class="lead">
            ...
            <div class="col-md-7 img">
              <hr>
                <div class="code-preview">
                  <img src="../manual_images/img/otherimages2/social behaviour.jpg" class="img-fluid" alt="Responsive image">
                </div>
                <hr>
          </div>
          <div class="row justify-content-around m-4 mb-6">
