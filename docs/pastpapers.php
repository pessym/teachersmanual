      ...
      <div class="container">
        <div class="row">
          ...
          <article>
            <h2>Past Papers</h2>
            <p class="lead">
              This page allows the teacher to view all the past papers posted by the  <b> admin</b>.
            </p>
            <hr>
            <div class="code-preview">
              <img src="../manual_images/img/otherimages/pastpapers.jpg" class="img-fluid" alt="Responsive image">
            </div>
