    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2 col-xl-9 ml-md-auto py-1"  style="margin-top:100px">
          <article>
                <h2>News Letter Tab</h2>
                <p class="lead">
                    On this page, a grid view of all the news letter posted by the administrator can be seen.
                </p>
                <hr>
                <div class="code-preview">
                <img src="../manual_images/img/otherimages/newsletter.jpg" class="img-fluid" alt="Responsive image">
                </div>
