      ...
      <div class="row">
        ...
        <div class="col-md-2 col-xl-9 ml-md-auto py-1">
          <article>
            ...
            <h2>View of Student List</h2>
            <p class="lead">Here is a displays loaned employees, Where you can give other employees loans, Edit, Delete or Deactivate.
              <br> To add employees to loans, You click the <b>Add Loan</b> button.
            </p>
