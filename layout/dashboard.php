         ...
         <!--
          ...
          <article>
            ...
            <div class="code-preview">
              <img src="../manual_images/img/images/login.jpg" class="img-fluid" alt="Responsive image">
            </div>
          ...
          <article>
            ...
            <h2>Landing Page</h2>
            <p class="lead">
              Upon successful logging in into the system, the landing page will be displayed as the one shown below.
              <ul class="lead">
            ...
            <div class="code-preview">
              <img src="../manual_images/img/otherimages/dashboard.jpg" class="img-fluid" alt="Responsive image">
            </div>
