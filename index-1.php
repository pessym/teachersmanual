...
<!-- Mirrored from thetheme.io/thedocs/layout/general-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Jan 2023 10:31:00 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>TheDocs - General layout 1</title>
        ...
        <section class="navbar-mobile">
          ...
          <ul class="nav nav-navbar">
            <li class="nav-item">
              ...
              <nav class="nav">
                <a class="nav-link" href="general-1.html">General 1</a>
                <a class="nav-link" href="general-2.html">General 2</a>
                <a class="nav-link" href="general-3.html">General 3</a>
                <a class="nav-link" href="minimal-1.html">Minimal 1</a>
                <a class="nav-link" href="minimal-2.html">Minimal 2</a>
                <a class="nav-link" href="one-page-1.html">One Page</a>
              </nav>
            </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav">
                <li class="nav-item">
                  <a class="nav-link" href="#">Homepage <span class="arrow"></span></a>
                  <nav class="nav">
                    <a class="nav-link" href="../help/homepage-1.html">Homepage 1</a>
                    <a class="nav-link" href="../help/homepage-2.html">Homepage 2</a>
                  </nav>
                </li>

                <li class="nav-item">
                  <a class="nav-link" href="#">Archive <span class="arrow"></span></a>
                  <nav class="nav">
                    <a class="nav-link" href="../help/archive-1.html">Archive 1</a>
                    <a class="nav-link" href="../help/archive-2.html">Archive 2</a>
                    <a class="nav-link" href="../help/archive-3.html">Archive 3</a>
                  </nav>
                </li>

                <li class="nav-item">
                  <a class="nav-link" href="#">Article <span class="arrow"></span></a>
                  <nav class="nav">
                    <a class="nav-link" href="../help/article-1.html">Article 1</a>
                    <a class="nav-link" href="../help/article-2.html">Article 2</a>
                    <a class="nav-link" href="../help/article-3.html">Article 3</a>
                  </nav>
                </li>

                <li class="nav-item">
                  <a class="nav-link" href="#">FAQ <span class="arrow"></span></a>
                  <nav class="nav">
                    <a class="nav-link" href="../help/faq-1.html">FAQ 1</a>
                    <a class="nav-link" href="../help/faq-2.html">FAQ 2</a>
                    <a class="nav-link" href="../help/faq-3.html">FAQ 3</a>
                  </nav>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav">
                ...
                <li class="nav-item">
                  ...
                  <nav class="nav">
                    <a class="nav-link" href="../page/changelog-1.html">Changelog 1</a>
                    <a class="nav-link" href="../page/changelog-2.html">Changelog 2</a>
                  </nav>
                </li>
      ...
      <div class="container">
        <div class="row gap-y">
          <div class="col-lg-3 text-center">
            <p>
              <a href="#"><img src="../assets/img/logo-dark.png" alt="logo"></a><br>
...
<!-- Mirrored from thetheme.io/thedocs/layout/general-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Jan 2023 10:31:06 GMT -->
</html>
